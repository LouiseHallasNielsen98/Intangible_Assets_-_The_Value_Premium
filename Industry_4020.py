...
avg_intangibles_df.to_excel('avg_intangibles_to_mv_per_year_4020.xlsx', index=False)
df.to_excel('4020.xlsx', index=False)
...
factor_returns.to_excel('4020.xlsx', index=False)
