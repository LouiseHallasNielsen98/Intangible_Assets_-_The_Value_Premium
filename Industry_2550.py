...
def compute_initial_intangible(group):
    ...
    int_i0 = (0.50 * first_sga / (δ_SGA + g_SGA)) + (0.70 * first_rd / (δ_RD + g_RD))
...
avg_intangibles_df.to_excel('avg_intangibles_to_mv_per_year_2550.xlsx', index=False)
...
factor_returns.to_excel('2550.xlsx', index=False)
